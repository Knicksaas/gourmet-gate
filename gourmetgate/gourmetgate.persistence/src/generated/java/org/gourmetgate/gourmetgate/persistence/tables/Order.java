...
public class Order extends TableImpl<OrderRecord> {
  ...
  /**
   * The column <code>Schema.order.PRINTED</code>.
   */
  public final TableField<OrderRecord, Boolean> PRINTED = createField(DSL.name("PRINTED"), SQLDataType.BOOLEAN.nullable(false).defaultValue(DSL.field("false", SQLDataType.BOOLEAN)), this, "");
